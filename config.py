...
RAG_ANSWER_PROMPT = """Используя предоставленный контекст, дай прямой и полезный ответ на вопрос пользователя.
...
Инструкции:
- Отвечай сразу по существу, без вступительных фраз типа "На основе контекста" или "Можно дать следующий ответ"
- Используй только информацию из контекста
- Будь конкретен и полезен
- Если информации недостаточно, скажи прямо об отсутствии данных
- Не добавляй лишние формулировки
